<section>
        ...
        <article>
            <h3>L’AXE</h3>
            <p>La mobilisation allemande fut également remarquable, l’Allemagne exploita aussi les ressources des pays qu’elle avait conquis. En 1942, Albert Speer fut nommé ministre de l’Armement et de l’Économie de guerre (ministère créé pour l’occasion), l’économie allemande fut retravaillée du tout au tout. La production de guerre tripla en 2 ans, plus de 7 millions d’hommes et de femmes travaillaient dans les usines allemandes, tandis que 7 autres millions travaillaient dans le reste de l’Europe occupée au service de l’Allemagne. La conversion économique fut plus ardue pour le Japon, sa production n’augmenta que de 44 % entre 1937 et 1944 et 95 % de sa marine marchande fut coulée par la marine américaine, ce qui mina ses ressources.</p>
        </article>
        <article>
            <h3>LA SCIENCE</h3>
            <img id="v2" src="<?php echo Settings::getAdresseRoot(); ?>/galerie/v2.jpg">
            <p>La recherche scientifique connue également un bon énorme, en particulier dans les domaines de la physique et de la mécanique. De nouveaux moyens de détection furent inventer, tels que le radar ou l’ASDIC (sonar). Le premier calculateur automatique (ordinateur) fut mis au point, les armes antichar telles que le bazooka furent développer. Les premiers avions à réaction prirent leurs envols (surtout en Allemagne) et les fusées V1 et V2 bombardèrent l’Angleterre.</p>
        </article>
        <article>
            <h3>L’IDÉOLOGIE</h3>
            <img id="japan" src="<?php echo Settings::getAdresseRoot(); ?>/galerie/japan.jpg">
            <p>Cette guerre fut également une guerre idéologique. Hitler voulait que l’Allemagne récupère son « espace vitale » puis il mena sa « croisade contre le bolchevisme ». Les Japonais furent fanatisés grâce à des dérivés extrémistes venant du code Bushido, ceux-ci préféraient mourir que d’êtres pris.</p>
        </article>
        <article>
            <h3>DES PROPORTIONS INÉGALÉES</h3>
            <p>Lors de cette guerre, on vit parmi les plus grandes batailles de l’Histoire, la seule bataille de Koursk mobilisa 2 300 000 d’hommes, 30 000 canons, 6 300 chars et 4 400 avions. Cette guerre fut également celle ou l’aéronavale fit son apparition en tant que grande force, l’exemple parfait est l’attaque de Pearl Harbor ou la marine américaine fut presque entièrement décimée par une attaque aérienne minutieusement préparée. L’Allemagne fut rasée par les bombardements alliés et des machines impressionnantes telles que le B-17 firent leur apparition.</p>
        </article>
    
    <div id="choiFleche">
            <div id="choiGauche">
            <div id="flecheDroite"><a href="<?php echo Settings::getServerRoot()."?action=AG";?>"><img id="imageFleche" src="<?php echo Settings::getAdresseRoot(); ?>/galerie/arrowGauche.png"></a></div>
            </div>
            <div id="choiDroite">
            <div id="flecheDroite"><a href="<?php echo Settings::getServerRoot()."?action=PI";?>"><img id="imageFleche" src="<?php echo Settings::getAdresseRoot(); ?>/galerie/arrowDroite.png"></a></div>
            </div>
        </div>
        </section>