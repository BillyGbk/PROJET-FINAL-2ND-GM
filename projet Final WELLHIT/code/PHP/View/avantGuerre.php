<section>
        ...
        <div id="choiFleche">
            <div id="choiGauche">
                <div id="flecheGauche"><a href="<?php echo Settings::getServerRoot();?>"><img id="imageFleche" src="<?php echo Settings::getAdresseRoot(); ?>/galerie/arrowGauche.png"></a></div>
            </div>
            <div id="choiDroite">
                <div id="flecheDroite"><a href="<?php echo Settings::getServerRoot()."?action=2GM";?>"><img id="imageFleche" src="<?php echo Settings::getAdresseRoot(); ?>/galerie/arrowDroite.png"></a></div>
            </div>
        </div>
    </section>